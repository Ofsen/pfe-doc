...
\section{Présentation des interfaces}
    ...
    \subsection{Interface invité 'Calen\acs{DRI} er des menus'}
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.21]{PFE Screens/Invité/Restauration/Calen\acs{DRI} er des menus.jpg}
        \caption{Interface invité 'Calen\acs{DRI} er des menus'}
    \end{figure}

    \subsection{Interface invité 'Détail d'un menus'}
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.21]{PFE Screens/Invité/Restauration/Calen\acs{DRI} er des menus - Détail.jpg}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.21]{PFE Screens/Admin/Restauration/Calen\acs{DRI} er/Détails du moi.jpg}
