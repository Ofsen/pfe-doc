...
\begin{document}
	...
	\begin{titlepage}
		...
		\begin{center}
			...
			\leftskip=4.5cm
			Président : M$^{r}$ \textsc{Daoui} Mehammed \\
	...
	\begin{center}
		...
		Nous tenons à exprimer notre profonde gratitude à notre encadreur \textbf{Mme GOUMEZIANE Lynda}, pour nous avoir encadrée et guidée et surtout pour ses judicieux conseils qui ont contribué à alimenter notre réflexion.\\
